...
public class Acreedor {
    ...
    public Acreedor(String nombre, String nif, String telefono, String email, String imageUri, String imgStorage){
        this.nombre = nombre;
        this.nif = nif;
    ...
    public Acreedor(String nombre, String nif, String telefono, String email, Uri imageUri, Uri imgStorage){
        this.nombre = nombre;
        this.nif = nif;
        this.telefono = telefono;
        this.email = email;
