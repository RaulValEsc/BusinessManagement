...
public class Cliente {
    ...
    public Cliente(String nombre, String dni, String telefono, String email, String imageUri, String imgStorage){
        this.nombre = nombre;
        this.dni = dni;
    ...
    public Cliente(String nombre, String dni, String telefono, String email, Uri imageUri, Uri imgStorage){
        this.nombre = nombre;
        this.dni = dni;
        this.telefono = telefono;
        this.email = email;
